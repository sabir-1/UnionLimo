<template>
  <footer class="footer footer-white bg-2 footer-4">
    <div class="footer-1">
          ...
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 text-md-start text-center mb-15 wow fadeInLeft">
              <div class="d-flex align-items-center justify-content-md-start justify-content-center">
                <a href="#" class="mr-30">
                  <img src="/imgs/template/logo-black.svg" alt="Luxride" />
                </a>
            ...
            <div class="col-lg-6 col-md-6 text-md-end text-center mb-15 wow fadeInLeft">
...
<script setup>
// FooterVariation6 component logic
</script>

<style scoped>
/* FooterVariation6 specific styles */
</style> 