  ...
  <footer class="footer footer-6">
    <div class="footer-1">
      <div class="container-sub">
        <div class="row mb-40">
          <div class="col-lg-3 width-20 mb-30 wow fadeInLeft">
            <h5 class="text-18-medium color-white mb-10">Address</h5>
            <p class="text-14 color-white mb-30">184 Main Collins Street West Victoria 8007</p>
            <h5 class="text-18-medium color-white mb-10">Call Our Office</h5>
            <p class="text-14 color-white mb-30">184 Main Collins Street West Victoria 8007</p>
            <h5 class="text-18-medium color-white mb-10">Working Hours</h5>
            <p class="text-14 color-white">
              Mon-Sat: 09:00 - 17:00<br>
              Sun: Closed
            </p>
          </div>
          <div class="col-lg-3 width-20 wow fadeInLeft">
          ...
          <div class="col-lg-3 width-20 mb-30 wow fadeInDown">
          ...
          <div class="col-lg-3 width-20 mb-30 wow fadeInRight">
            <h5 class="text-18-medium color-white mb-20">Classes</h5>
            <ul class="menu-footer">
...
<script setup>
// FooterVariation8 component logic
</script>

<style scoped>
/* FooterVariation8 specific styles */
</style> 