              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide"> 
                  <div class="cardFleet wow fadeInUp">
                    <div class="cardInfo"><a href="fleet-single.html">
                      ...
                      <p class="text-14 color-text mb-30">Mercedes-Benz V-Class, Chevrolet Suburban, Cadillac</p>
                    </div>
                    <div class="cardImage mb-30"><a href="fleet-single.html"><img src="/imgs/page/homepage1/e-class.png" alt="Luxride"></a></div>
                ...
                <div class="swiper-slide"> 
                  <div class="cardFleet wow fadeInUp">
                    ...
                    <div class="cardImage mb-30"><a href="fleet-single.html"><img src="/imgs/page/homepage1/eqs.png" alt="Luxride"></a></div>
                    <div class="cardInfoBottom">
                      <div class="passenger"><span class="icon-circle icon-passenger"></span><span class="text-14">Passengers<span>4</span></span></div>
                      <div class="luggage"><span class="icon-circle icon-luggage"></span><span class="text-14">Luggage<span>2</span></span></div>
                    </div>
                ...
                <div class="swiper-slide"> 
                  <div class="cardFleet wow fadeInUp">
                    ...
                    <div class="cardImage mb-30"><a href="fleet-single.html"><img src="/imgs/page/homepage1/suv.png" alt="Luxride"></a></div>
                    <div class="cardInfoBottom">
                      <div class="passenger"><span class="icon-circle icon-passenger"></span><span class="text-14">Passengers<span>4</span></span></div>
                      <div class="luggage"><span class="icon-circle icon-luggage"></span><span class="text-14">Luggage<span>2</span></span></div>
                    </div>
                ...
                <div class="swiper-slide"> 
                  <div class="cardFleet wow fadeInUp">
                    ...
                    <div class="cardImage mb-30"><a href="fleet-single.html"><img src="/imgs/page/homepage1/v-class.png" alt="Luxride"></a></div>
                    <div class="cardInfoBottom">
                      <div class="passenger"><span class="icon-circle icon-passenger"></span><span class="text-14">Passengers<span>4</span></span></div>
                      <div class="luggage"><span class="icon-circle icon-luggage"></span><span class="text-14">Luggage<span>2</span></span></div>
                    </div>
