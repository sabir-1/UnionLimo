      ...
      <div class="row">
            ...
            <div class="swiper-container swiper-group-testimonials pb-50">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="cardQuote wow fadeInRight">
                    <div class="box-quote">
              ...
              <div class="box-pagination-testimonials mt-40 wow fadeInRight">
        ...
        <div class="col-lg-7 col-md-6 mb-30 text-lg-end text-center d-none d-md-block">
          <div class="box-video wow fadeInRight">
            <a class="btn btn-play popup-youtube hover-up" href="https://www.youtube.com/watch?v=sVPYIRF9RCQ"></a>
            <img src="/imgs/page/homepage1/img-video.png" alt="luxride" />
          </div>
        </div>
      </div>
    </div>
